import { AlertCircle, Mail, Plus, RefreshCw, X } from "lucide-react";
import React, { useCallback, useEffect, useState } from "react";
import { Controller, useForm } from "react-hook-form";
import { toast, ToastContainer } from "react-toastify";
import "react-toastify/dist/ReactToastify.css";
import TableComponent from "../components/layout/TableComponent";
import { AuthContext } from "../context/AuthHooks";
...
const VerifierUser = () => {
  ...
  }, [base_api_url, handleUnauthorized, playSound]);
        ...
        <div className="w-full">
          ...
          <div className="mb-6">
            <div className="flex flex-col md:flex-row gap-4 items-start md:items-end justify-between">
              ...
              <button
                        className="inline-flex items-center px-4 py-2 bg-emerald-600 text-white rounded-lg hover:bg-emerald-700 transition-colors text-sm font-medium h-[42px]"
                        onClick={() => openModal()}
                      >
              ...
              <div className="bg-white rounded-lg shadow-xl w-full max-w-md">
                ...
                <div className="p-6">
                  ...
                  <div className="flex justify-end gap-2">
                    ...
                    <button
                      className="px-4 py-2 bg-emerald-600 text-white rounded-lg hover:bg-emerald-700 transition-colors text-sm font-medium flex items-center justify-center disabled:opacity-50 disabled:cursor-not-allowed min-w-[120px]"
