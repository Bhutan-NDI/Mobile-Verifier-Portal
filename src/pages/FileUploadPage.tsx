...
const FileUploadPage = () => {
  ...
  }, [base_api_url, handleUnauthorized]);

  useEffect(() => {
    if (isAuthenticated) {
      fetchFileData();
    }
  }, [isAuthenticated, fetchFileData]);

  // Open delete modal and set file to delete
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-6">
        <div className="flex-1">
          ...
          <div className="relative w-full">
            ...
            />
            <div
              className="w-full px-4 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent hover:border-emerald-300 transition duration-200 flex justify-between items-center cursor-pointer"
        ...
        <div className="flex gap-2">
          ...
          {attachedFile && (
            <button
              ...
              className="inline-flex items-center px-4 py-2 border border-emerald-500 text-emerald-600 rounded-lg hover:bg-emerald-50 transition-colors text-sm font-medium h-[42px]"
            >
